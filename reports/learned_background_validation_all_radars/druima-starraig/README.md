# Learned Background Validation: druima-starraig 20260703 lp DBZH dataset1

Status: real-data hold-out validation complete.

- Training: 60 real public PVOL/HDF5 scans (1210 to 1705)
- Hold-out validation: 20 scans (1710 to 1845)
- Model: `src/uk_wsr_visualizer/models/background/druima-starraig_lp_dbzh_dataset1_20260703.json`
- Shape: 360 azimuth rays x 425 range bins
- Mean held-out background-clutter mask share: 11.67%
- Range across hold-out scans: 11.62% to 11.68%
