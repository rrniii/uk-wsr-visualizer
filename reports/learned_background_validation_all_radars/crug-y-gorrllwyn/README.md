# Learned Background Validation: crug-y-gorrllwyn 20260703 lp DBZH dataset1
...
- Model: `src/uk_wsr_visualizer/models/background/crug-y-gorrllwyn_lp_dbzh_dataset1_20260703.json`
- Shape: 360 azimuth rays x 425 range bins
- Mean held-out background-clutter mask share: 9.42%
- Range across hold-out scans: 9.40% to 9.42%
