# Learned Background Validation: cobbacombe 20260703 lp DBZH dataset1

Status: real-data hold-out validation complete.

- Training: 60 real public PVOL/HDF5 scans (1210 to 1710)
- Hold-out validation: 20 scans (1715 to 1850)
- Model: `src/uk_wsr_visualizer/models/background/cobbacombe_lp_dbzh_dataset1_20260703.json`
- Shape: 360 azimuth rays x 425 range bins
- Mean held-out background-clutter mask share: 10.94%
- Range across hold-out scans: 10.93% to 10.94%
