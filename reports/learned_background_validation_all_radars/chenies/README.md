# Learned Background Validation: chenies 20260703 lp DBZH dataset1
...
- Model: `src/uk_wsr_visualizer/models/background/chenies_lp_dbzh_dataset1_20260703.json`
- Shape: 360 azimuth rays x 425 range bins
- Mean held-out background-clutter mask share: 7.89%
- Range across hold-out scans: 7.87% to 7.90%
