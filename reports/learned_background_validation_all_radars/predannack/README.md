# Learned Background Validation: predannack 20260703 lp DBZH dataset1
...
- Model: `src/uk_wsr_visualizer/models/background/predannack_lp_dbzh_dataset1_20260703.json`
- Shape: 360 azimuth rays x 425 range bins
- Mean held-out background-clutter mask share: 4.34%
- Range across hold-out scans: 4.33% to 4.34%
