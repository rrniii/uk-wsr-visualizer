# Learned Background Validation: druima-starraig 2026-07-03 LP DBZH dataset1

Status: real-data hold-out validation complete.

- Training: 60 real public PVOL/HDF5 LP scans (1210 to 1705)
- Hold-out validation: 20 scans (1710 to 1845)
- Model: `models/background/druima-starraig_lp_dbzh_dataset1_20260703.json`
