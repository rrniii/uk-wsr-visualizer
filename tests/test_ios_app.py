...
class IOSAppProjectTests(unittest.TestCase):
    ...
    def test_ios_bundle_uses_only_registry_qualified_background_models(self):
        ...
        self.assertEqual(manifest["model_count"], 187)
    ...
    def test_ios_app_has_native_catalog_cache_and_rendering_core(self):
        ...
        self.assertIn("ukmo-nimrod/catalog/pvol/catalog.json", store)
        self.assertIn("ukmo-nimrod-pre-dual-pol/catalog/pvol/catalog.json", store)
        ...
        self.assertIn("Partial MP4 saved to Files > On My Device > UK WSR > Downloads", content_view)
        ...
        self.assertIn("MP4 saved to Files > On My Device > UK WSR > Downloads.", content_view)
        ...
        self.assertIn("Keeping this device awake while exporting", content_view)
