...
class IOSAppProjectTests(unittest.TestCase):
    ...
    def test_ios_app_has_native_catalog_cache_and_rendering_core(self):
        ...
        self.assertIn("Renderable only", content_view)
        self.assertIn("Cached only", content_view)
        self.assertIn("Sort", content_view)
        self.assertIn("Variable", content_view)
        ...
        self.assertIn("Variables unknown", store)
    ...
    def test_ios_readme_documents_device_install_path(self):
        ...
        self.assertIn("renderable/cache status", readme)
        ...
        self.assertIn("renderable", checklist)
        self.assertIn("cached only", checklist)
