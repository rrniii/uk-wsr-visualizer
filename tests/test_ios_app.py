...
class IOSAppProjectTests(unittest.TestCase):
    ...
    def test_ios_app_has_native_catalog_cache_and_rendering_core(self):
        ...
        self.assertIn("Quick Actions", content_view)
        self.assertIn("Nearest latest", content_view)
        self.assertIn("Latest uploaded", content_view)
        self.assertIn("Current radar", content_view)
        ...
        self.assertIn("selectLatestUploadedDay", store)
