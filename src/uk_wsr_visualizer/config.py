...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        data_dir = Path(os.environ.get("UK_WSR_VISUALIZER_DATA_DIR", str(DEFAULT_DATA_DIR)))
        return cls(
            aggregate_base=Path(os.environ.get("UK_WSR_VISUALIZER_AGGREGATE_BASE", str(DEFAULT_AGGREGATE_BASE))),
            data_dir=data_dir,
            catalog_path=Path(os.environ.get("UK_WSR_VISUALIZER_CATALOG", str(data_dir / "catalog.json"))),
            preview_dir=Path(os.environ.get("UK_WSR_VISUALIZER_PREVIEW_DIR", str(data_dir / "previews"))),
