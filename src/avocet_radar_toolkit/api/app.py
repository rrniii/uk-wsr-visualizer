"""FastAPI app for the Avocet Radar Toolkit."""
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(title="Avocet Radar Toolkit", version="0.1.0")
    ...
    def local_dataset_payload() -> dict[str, object]:
        ...
        return public_dataset_metadata_payload(
            ...
            "uk-radar",
            {
                ...
                "description": "Public metadata fallback generated from the local Avocet Radar Toolkit catalog.",
                "license": "proprietary",
                "citation": "",
